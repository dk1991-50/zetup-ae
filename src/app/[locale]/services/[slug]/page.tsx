...
const SERVICE_DATA: Record<string, ServiceData> = {
  "pro-services": {
    meta: {
      title: "PRO Services Dubai — Transparent Government Liaison | ZETUP",
      description:
        "ZETUP provides transparent PRO services for Dubai mainland companies. Visa processing, trade license renewals, document clearing, and Emiratisation compliance. From AED 8,000/month.",
    },
    h1: "PRO Services in Dubai — Government Liaison Without the Headaches",
    answerCapsule:
      "PRO services in Dubai handle all government liaison work for your business — including visa processing, trade license renewals, Emirates ID registration, labour card processing, Emiratisation compliance, and document attestation with MOHRE, DET, and GDRFA. ZETUP provides these services on a monthly retainer basis starting from AED 8,000/month for companies with 25+ employees, with transparent pricing and no hidden fees.",
    ...
    sections: [
      ...
      {
        heading: "How ZETUP's PRO Service Works",
        content:
      ...
      {
        heading: "Why Companies Switch Their PRO to ZETUP",
        content:
      ...
      },
      {
        ...
        content:
          "ZETUP's PRO services team has experience across every major sector operating on Dubai mainland.",
        list: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "ZETUP's corporate PRO retainers start from AED 8,000/month for companies with 25-40 employees. The exact cost depends on employee count, expected transaction volume, and service complexity. Government fees are billed separately at cost. We always provide a detailed written quote before engagement.",
      },
      {
        question:
          "Can I outsource PRO services instead of hiring an in-house PRO?",
        answer:
          "Yes, and it is typically 30-50% cheaper. An in-house PRO officer costs AED 8,000-15,000/month in salary alone, plus visa costs, insurance, and office space. With ZETUP, you get a full team for less than the cost of a single hire, with no HR liability.",
      },
      {
  ...
  "company-formation": {
    meta: {
      title: "Company Formation Dubai Mainland — Setup in Weeks | ZETUP",
      description:
        "Set up your Dubai mainland company with ZETUP. 100% foreign ownership, transparent costs, and step-by-step guidance from trade name to trade license. No hidden fees.",
    },
    h1: "Dubai Mainland Company Formation — Start Your Business With Full Transparency",
    answerCapsule:
      "Setting up a mainland company in Dubai costs approximately AED 25,000-50,000 in the first year, including trade license fees, visa costs, and office registration. The process takes 2-4 weeks from initial approval to trade license issuance. Since 2021, foreign investors can own 100% of mainland companies without a local sponsor for most business activities. ZETUP handles the entire formation process with transparent, itemized pricing.",
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "For a standard mainland LLC with foreign ownership, you will need the following documents. ZETUP provides a detailed, personalised document checklist based on your specific business activity and shareholder structure.",
        list: [
      ...
      {
        heading: "ZETUP's Formation Service Includes",
        content:
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Since June 2021, foreign investors can own 100% of mainland companies for most business activities. A few strategic sectors still require Emirati majority ownership, but ZETUP will confirm full eligibility for your specific activity during the initial consultation.",
      },
      {
  ...
  "visa-services": {
    meta: {
      title:
        "Visa Processing Dubai — Employment, Investor & Golden Visa | ZETUP",
      description:
        "ZETUP handles all visa processing for Dubai mainland companies. Employment visas, investor visas, Golden Visas, dependent visas — processed accurately the first time. No surprises.",
    },
    h1: "Visa Processing in Dubai — Every Visa Type, Handled End-to-End",
    answerCapsule:
      "Visa processing in Dubai covers employment visas (3-7 business days, AED 3,500-6,000 per employee), investor visas (5-10 days, AED 5,000-8,000), Golden Visas (2-4 weeks, 10-year residency), dependent visas (5-10 days, AED 3,000-5,000), and Green Visas (2-3 weeks, 5-year self-sponsored). ZETUP manages the full process for Dubai mainland companies — from MOHRE work permit through Emirates ID and residence visa stamping.",
    ...
    sections: [
      ...
      {
        heading: "How ZETUP's Visa Service Works",
        content:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. For all PRO retainer clients, we maintain a complete renewal calendar and send reminders 60 days before any visa expiry. You will never miss a renewal with ZETUP.",
      },
      {
  ...
  emiratisation: {
    ...
    sections: [
      ...
      {
        heading: "What ZETUP's Emiratisation Service Covers",
        content:
    ...
    faqs: [
      ...
      {
        question: "How quickly can ZETUP get us compliant?",
        answer:
  ...
  "trade-license-renewal": {
    meta: {
      title: "Trade License Renewal Dubai — Never Miss a Deadline | ZETUP",
      description:
        "ZETUP manages your Dubai trade licence renewal proactively. 60-day advance reminders, activity amendments, partner changes, and penalty prevention. No missed deadlines.",
    },
    h1: "Trade Licence Renewal in Dubai — Proactive, Not Reactive",
    answerCapsule:
      "Dubai trade licence renewal is an annual obligation with DET, costing approximately AED 10,000-15,000 in government fees depending on business activities. Late renewals trigger a AED 2,000 fine on day one and AED 1,000 per month thereafter. ZETUP manages renewals proactively with 60-day advance reminders and handles all associated requirements including establishment card renewals, activity amendments, and partner changes.",
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "ZETUP follows a structured timeline to ensure your licence is renewed well before the expiry date.",
        table: {
          headers: ["Step", "Timeline", "Action"],
          rows: [
            [
              "60 days before expiry",
              "ZETUP sends reminder",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["ZETUP processing fee", "Included in PRO retainer"],
          ],
        },
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Government fees range from AED 10,000-15,000 depending on business activities. ZETUP's processing is included in our PRO retainer — no additional fee for renewal handling.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Your Ejari must be updated to reflect your current address before DET will process the renewal. ZETUP handles Ejari updates as part of our service.",
      },
      {
        question: "Can ZETUP handle renewals for multiple entities?",
        answer:
  ...
  "corporate-tax": {
    meta: {
      title: "Corporate Tax Services Dubai — FTA Filing & Compliance | ZETUP",
      description:
        "ZETUP coordinates your UAE corporate tax compliance. FTA registration, EmaraTax portal management, filing deadline tracking, and accountant liaison. Small Business Relief guidance.",
    },
    h1: "UAE Corporate Tax Services — Government Coordination Made Simple",
    answerCapsule:
      "UAE Corporate Tax applies a 9% rate on taxable income above AED 375,000 for mainland companies. Small Business Relief (zero tax for revenue under AED 3 million) expires December 2026. ZETUP handles the government coordination layer — FTA registration, EmaraTax portal submissions, deadline tracking, and liaison with your accounting firm — from AED 2,000 per quarter.",
    priceRange: "AED 2,000 - AED 5,000/quarter",
    serviceName: "Corporate Tax Services Dubai",
    sections: [
      {
        heading: "What ZETUP Handles",
        content:
    ...
    faqs: [
      ...
      {
        question:
          "Do I need a separate accountant, or does ZETUP handle everything?",
        answer:
          "You need a qualified accountant for tax computation and financial statements. ZETUP handles the government coordination — registration, portal management, submission, and deadline tracking.",
      },
    ],
  },
  ...
  "document-clearing": {
    meta: {
      title: "Document Clearing & Attestation Dubai — MOFA, Embassy | ZETUP",
      description:
        "ZETUP handles document attestation, MOFA legalisation, embassy attestation, and certificate clearing in Dubai. Fast processing, transparent pricing, status tracking.",
    },
    h1: "Document Clearing and Attestation in Dubai — Fast, Tracked, Transparent",
    answerCapsule:
      "Document clearing services in Dubai handle the attestation and legalisation of documents required for business and personal purposes — including MOFA attestation, embassy legalisation, notary public services, educational certificate attestation, and commercial document clearing. ZETUP processes all document types with real-time status tracking and transparent per-document pricing.",
  ...
  "golden-visa": {
    meta: {
      title: "Golden Visa Dubai 2026 — 10-Year Residency Application | ZETUP",
      description:
        "ZETUP handles end-to-end Golden Visa applications in Dubai. Updated Feb 2026 criteria: AED 2M property (no down payment), new AI & creator categories. Processing in 2-4 weeks.",
    },
    h1: "Golden Visa Dubai — 10-Year Residency, Processed End-to-End",
    answerCapsule:
      "The UAE Golden Visa grants 10-year residency without a sponsor, with benefits including extended overseas stays and family sponsorship. As of February 2026, property investors qualify with a DLD valuation of AED 2 million (no down payment requirement). ZETUP provides end-to-end application management for AED 5,000-10,000 plus government fees of approximately AED 3,000-5,000.",
    ...
    sections: [
      ...
      {
        heading: "ZETUP's Golden Visa Service",
        content:
...
export async function generateMetadata({
  ...
  if (!service) {
    return { title: "Service Not Found | ZETUP" };
  }
